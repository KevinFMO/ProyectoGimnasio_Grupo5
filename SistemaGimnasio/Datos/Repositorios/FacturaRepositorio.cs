    ...
    public class FacturaRepositorio : IFacturaRepositorio
    {
        ...
        public async Task<int> Nueva(Factura factura)
        {
            ...
            try
            {
                ...
                string sql = @"INSERT INTO factura (Fecha, Cliente, ISV, Descuento, Subtotal,Total, FechaVencimiento, CodigoUsuario)
                                VALUES (@Fecha, @Cliente, @ISV, @Descuento, @Subtotal, @Total, @FechaVencimiento, @CodigoUsuario); SELECT LAST_INSERT_ID()";
